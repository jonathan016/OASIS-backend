...
public class APIMappingValue {
    ...
    public static final String API_DATA_ASSET = "/{identifier:^SKU(-[0-9]{3}){3}$}";
    public static final String API_IMAGE_ASSET = "/{identifier:^SKU(-[0-9]{3}){3}$}/{image:.+}";
    public static final String API_PDF_ASSET = "/{identifier:^SKU(-[0-9]{3}){3}$}/pdf";
