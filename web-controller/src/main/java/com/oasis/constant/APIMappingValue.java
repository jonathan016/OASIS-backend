...
public class APIMappingValue {
    ...
    public static final String API_DETAIL_ASSET = "/api/assets/{assetSku}";
    public static final String API_IMAGE_ASSET = "/api/assets/{assetSku}/{assetPhotoName}.{extension}";
    public static final String API_PDF_ASSET = "/api/assets/{assetSku}/pdf";
