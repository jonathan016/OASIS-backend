...
public class APIMappingValue {
    ...
    public static final String API_DASHBOARD_STATUS = "/api/dashboard/status/{nik}";
    public static final String API_DASHBOARD_REQUEST_UPDATE = "/api/dashboard/request-update/{nik}";
    ...
    public static final String API_IMAGE_ASSET = "/api/assets/{sku}/{assetPhotoName}.{extension}";
    ...
    public static final String API_DETAIL_EMPLOYEE = "/api/employees/{nik}";
