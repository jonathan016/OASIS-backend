...
import com.oasis.web_controller.security.OasisAccessDeniedHandler;
import com.oasis.web_controller.security.OasisAuthenticationFailureHandler;
import com.oasis.web_controller.security.OasisAuthenticationProvider;
import com.oasis.web_controller.security.OasisRestAuthenticationEntryPoint;
...
import static com.oasis.model.constant.service_constant.RoleConstant.ROLE_ADMINISTRATOR;
import static com.oasis.model.constant.service_constant.RoleConstant.ROLE_EMPLOYEE;
import static com.oasis.model.constant.service_constant.RoleConstant.ROLE_SUPERIOR;
...
public class WebSecurityConfiguration
    ...
    protected void configure(final HttpSecurity http)
        ...
        http.cors().configurationSource(corsConfigurationSource()).and().csrf().disable().anonymous()
            ...
            .antMatchers(HttpMethod.GET, API_REQUEST.concat(API_OTHERS_REQUESTS))
