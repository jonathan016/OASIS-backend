...
public class EmployeesController {
    ...
    public ResponseEntity getEmployeesList(
        ...
        return new ResponseEntity<>(
                employeesResponseMapper.produceViewFoundEmployeesSuccessResult(HttpStatus.OK.value(), employeesFound,
                                                                               supervisorsFound, employeePhotos, page,
                                                                               totalRecords
                ), HttpStatus.OK);
    }
    ...
    public ResponseEntity getEmployeeDetailData(
        ...
        return new ResponseEntity<>(
                employeesResponseMapper.produceEmployeeDetailSuccessResponse(HttpStatus.OK.value(), employee, photo,
                                                                             supervisor
                ), HttpStatus.OK);
    }
    ...
    public ResponseEntity getEmployeePhoto(
        ...
        photo = employeesServiceImpl.getEmployeePhoto(username, image, extension);
    ...
    public ResponseEntity saveEmployee(
        ...
        try {
            ...
            username = employeesServiceImpl.saveEmployee(photo, adminUsername,
                                                         employeesRequestMapper.getEmployeeModelFromRawData(
                                                                 rawEmployeeData, isAddOperation),
                                                         employeesRequestMapper.getSupervisorUsernameFromRawData(
                                                                 rawEmployeeData), isAddOperation
            );
        ...
        if (isAddOperation) {
            ...
            return new ResponseEntity<>(
                    employeesResponseMapper.produceEmployeeSaveUpdateSuccessResult(HttpStatus.CREATED.value()),
                    HttpStatus.CREATED
            );
        }
    }
    ...
    public ResponseEntity changeSupervisorOnPreviousSupervisorDeletion(
        ...
        try {
            employeesServiceImpl.changeSupervisorOnPreviousSupervisorDeletion(request.getAdminUsername(),
