...
import com.oasis.web_controller.mapper.request.EmployeesRequestMapper;
import com.oasis.web_controller.mapper.response.EmployeesResponseMapper;
...
public class EmployeesController {
    ...
    public ResponseEntity getEmployeeDetailData(
        ...
        return new ResponseEntity<>(
                employeesResponseMapper.produceEmployeeDetailSuccessResponse(
                        HttpStatus.OK.value(), activeComponentManager.getEmployeeDetailActiveComponents(
                                new ArrayList<>(user.getAuthorities()).get(0).getAuthority()), employee, photo,
                        supervisor
                ), HttpStatus.OK
        );
    }
