...
public class AssetsController {
    ...
    public ResponseEntity getAssetDetailData(
            @PathVariable(value = "identifier") final String sku
    ) {
    ...
    public ResponseEntity saveAsset(
            @RequestParam(value = "photos") final List<MultipartFile> photos,
            @RequestParam(value = "data") final String rawAssetData
    ) {
