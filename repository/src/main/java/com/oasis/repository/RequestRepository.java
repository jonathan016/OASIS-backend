...
public interface RequestRepository
    ...
    Page< RequestModel > findAllByUsernameEqualsAndStatusEqualsOrSkuContainsIgnoreCaseOrderByStatusDesc(
            String username, String status, String sku, Pageable pageable
    );
    ...
    Page< RequestModel > findAllByUsernameEqualsAndStatusEqualsOrSkuContainsIgnoreCaseOrderByUpdatedDateDesc(
            String username, String status, String sku, Pageable pageable
    );
